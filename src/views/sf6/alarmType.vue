<template>
  <div class="sf6-alarm-type">
    ...
    <el-table :data="tableList" stripe style="width: 100%">
      <el-table-column prop="alarmType" label="报警类型" width="80px">
      </el-table-column>
      <el-table-column prop="createTime" label="报警时间" width="180px">
      </el-table-column>
      <!-- <el-table-column prop="deviceId" label="传感器编号"> </el-table-column> -->
      <el-table-column prop="deviceName" label="主设备名称" width="200px">
      </el-table-column>
      <el-table-column prop="deviceId" label="传感器编号" width="200px">
      </el-table-column>
  ...
  methods: {
   ...
   // 修改列表条数
    ...
    async getList() {
      ...
      this.tableList = alarmListData.page.records
      this.total = alarmListData.total
