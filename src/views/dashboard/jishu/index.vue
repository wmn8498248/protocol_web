              ...
              <div class="warp" style="height: initial">
                <ul class="item">
                  <li>
                    ...
                    <span class="title" v-text="'次数'"></span>
  ...
  export default {
    ...
    methods: {
      ...
      async getList() {
        ...
        const { records } = await api.deviceList({
          companyId: this.companyId,
          pageNum: 1,
          pageSize: 100,
        });
      ...
      async handleGoToDetail(res) {
        ...
        if (this.dataDetailsList.length > 0) {
          ...
          deviceName = this.dataDetailsList[res].name;
        }

        console.log(deviceName, "deviceName___________")
      ...
      async changeTimes(times) {
        ...
        this.handleGoToDetail(this.selectIndex)
      },
      ...
      async getData() {
        const { deviceCount, deviceType, voltLevel } = await api.indexData({
          companyId: this.companyId,
        });
