            ...
            <div class="warp" style="height: initial">
              <ul class="item">
                <li>
                  ...
                  <span class="title" v-text="'形变(με)'"></span>
      ...
      <div class="home-flex">
        <div class="home-box flex10">
          <div class="box-title">
            ...
            <span class="right">形变: με&emsp;温度: ℃</span>
...
export default {
  ...
  methods: {
    ...
    chart4Refresh(res, hisTitle) {
      ...
      dateTime.forEach((element) => {
        dateListTemperature.push(parseFloat(element.temperature));

        deformationList.push(parseFloat(element.deformation));
