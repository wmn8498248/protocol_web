      ...
      <div class="dashboard-left">
        ...
        <div class="dashboard-box" style="margin-top: 20px">
          ...
          <div class="box-container">
            ...
            <div ref="chart1" style="width: 100%; height: 325px"></div>
          </div>
        </div>
      </div>
      ...
      <div class="dashboard-right">
        <div class="dashboard-box">
          ...
          <div class="box-container">
            ...
            <div class="box-content" style="height: calc(100% - 55px)">
              <div ref="chart0" style="width: 100%; height: 325px"></div>
  ...
  methods: {
    ...
    async getData() {
      ...
      this.myChart0.setOption({
        ...
        ],//deviceName pressure temperature electric
        series: [
          {
            name: "气压",
            type: "bar",
        ...
        series: [
          {
            ...
            data: [{name: "离线", value: todayCase.outline}, {name: "在线", value: todayCase.online}],
            // data: [this.todayCase.outline, this.todayCase.online],
