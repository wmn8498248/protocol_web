...
export default {
  ...
  methods: {
    ...
    async handleGoToDetail(res) {
      ...
      // const { historyList } = await api.tcDeviceHistoryList({
      //   deviceNumber: deviceNumber,
      //   dateType: dateType,
      // });
      // this.chart4Refresh(
      //   historyList,
      //   this.historyList[res.target.title].deviceName
      // );
    ...
    chart4Refresh(res, hisTitle) {
      ...
      dateTime.forEach((element) => {
        ...
        dateListPressure.push(parseFloat(element.humidity)); // 湿度
