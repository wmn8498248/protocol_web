<template>
  <div class="sf6-alarm-list">
    ...
    <el-table height="500px" :data="tableList" stripe style="width: 100%" @selection-change="selectionChangeHandle">
      ...
      <el-table-column prop="alarmValue" label="报警值(A)"> </el-table-column>
      ...
      <el-table-column label="操作" width="300px">
        <template slot-scope="scope">
          <el-button size="mini" @click="handleHistory(scope.row)"
            >查看数据</el-button
          >
          <el-button type="info" v-if="scope.row.status === 0" size="mini" @click="handleRead(scope.row.id)"
            >设置已读</el-button
          >
          <el-button type="danger" size="mini" round @click="handleDelete(scope.row.id)"
            >删除</el-button
          >
        </template>
      </el-table-column>
