    ...
    <div class="search-container">
      <el-form label-width="200px">
        ...
        <el-form-item label="温度报警上限(℃)" required>
          <el-input
            type="text"
            v-model="info.tempHigh"
            :disabled="disabled"
          ></el-input>
        </el-form-item>

        <el-form-item label="温度偏差上送值(℃)" required>
          <el-input
            type="text"
            v-model="info.tempOffset"
            :disabled="disabled"
          ></el-input>
        </el-form-item>
...
export default {
  ...
  activated() {
    ...
    // console.log(this.$route.query.info, 'this.$route.query.info')
    this.getInfo();
  },
  methods: {
    async defence() {
    ...
    async toSave() {
      ...
      validator.add(this.info.tempOffset, ["isNonEmpty", "请输入温度偏差上送值"]);
      validator.add(this.info.tempHigh, ["isNonEmpty", "请输入温度报警上限"]);
