<template>
  <div class="qingxiePage">
    ...
    <el-table :data="tableData" stripe style="width: 100%">
      ...
      <el-table-column prop="current" label="电流值（A）"> </el-table-column>
      <el-table-column prop="elect" label="电量（%）"> </el-table-column>
...
export default {
  ...
  methods: {
    async getData() {
      let { records, total } = await api.temperatureNewList({
