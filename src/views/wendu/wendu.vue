<template>
  <div class="qingxiePage">
    ...
    <el-table :data="tableData" stripe style="width: 100%">
      ...
      <el-table-column prop="nodeId" label="汇集单元识别码" width="180">
      </el-table-column>
      <el-table-column prop="sensorId" label="传感器编号" width="180">
      </el-table-column>
      ...
      <el-table-column label="操作" width="250">
          ...
          <el-button class="btn-data" size="mini" @click="goToDetail(row.projectNumber, row.companyId, row.projectId)">查看数据</el-button>
				</template>
      </el-table-column>
    </el-table>
...
export default {
  ...
  methods: {
		...
		// 查看数据 deviceCode实际上是projectNumber，版本遗留
		goToDetail(deviceCode, companyId, projectId) {
			this.$router.push({
			  path: `${this.$route.path}_data`,
			  query: {
			    deviceCode, companyId, projectId
			  },
			});
		},
		// 查看地图
