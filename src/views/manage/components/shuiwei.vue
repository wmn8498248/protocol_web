<template>
  <div class="bileiPage">
    ...
    <el-table :data="tableData" stripe>
      ...
      <el-table-column prop="gasHigh" label="水位告警高阈值mA"> </el-table-column>
      <el-table-column prop="gasLow" label="水位告警低阈值mA"> </el-table-column>
  ...
  methods: {
    ...
    async toDelete(deviceId) {
			this.$confirm('确定删除该设备?', '提示', {
				...
				await api.waterLevelDelete(data);
