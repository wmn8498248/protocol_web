<template>
    <div class="bileiPage">
      ...
      <el-table :data="tableData" stripe>
        ...
        <el-table-column prop="tcpAddress" label="tcpAddress"> </el-table-column>
        <el-table-column prop="tcpPort" label="tcpPort"></el-table-column>
        <!-- <el-table-column prop="wifiPassword" label="wifiPassword"> </el-table-column> -->
        <el-table-column prop="wifiSsid" label="wifiSsid"> </el-table-column>
        <el-table-column prop="onlineThreshold" label="离线阈值"> </el-table-column>
        <!-- <el-table-column prop="gatewayId" label="所属网关"> </el-table-column> -->
        
        <el-table-column prop="onOffStatus" label="开关状态">
          <template slot-scope="{ row }">
              <el-tag type="info" size="mini" v-if="row.onOffStatus === 0"> 关闭 </el-tag>
              <el-tag type="success" size="mini" v-else> 开启 </el-tag>
          </template>
        </el-table-column>
        ...
        <!-- <el-table-column prop="createTime" width="150" label="createTime">
        </el-table-column> -->
