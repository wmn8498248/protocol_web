  ...
  <div class="bileiPage">
    <div class="search-container">
      <el-form inline :model="searchModel" label-width="100px">
        <el-form-item label="">
          <el-input type="text" v-model="searchModel.deviceName" placeholder="传感器名称"></el-input>
        </el-form-item>
        <el-form-item label="">
    ...
    <el-table :data="tableData" stripe>
      <el-table-column prop="deviceId" label="传感器别名"> </el-table-column>
      <el-table-column prop="nodeId" label="汇集单元识别码"> </el-table-column>
  ...
  methods: {
    ...
    toDelete(deviceId) {
			this.$confirm('确定删除该设备?', '提示', {
				...
				await api.temperatureElectricDelete(data);
