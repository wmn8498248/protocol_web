<template>
  <div class="sf6-alarm-type">
    ...
    <el-table height="500px" :data="tableList" stripe style="width: 100%">
      ...
      <el-table-column prop="humidityValue" label="湿度(%)"> </el-table-column>
      <el-table-column prop="temperatureValue" label="温度(℃)"> </el-table-column>
...
export default {
  ...
  methods: {
    ...
    async getList() {
      this.tableData = await api.deviceStatus({
        companyId: this.$route.query.companyId,
        lineStatus: this.$route.query.lineState,
