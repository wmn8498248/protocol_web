...
export const deviceVoltLevel = (data) =>
  axios.request({
    url: "bt/temperature/index/list/voltLevel",
    method: "get",
    params: {
      ...data,
    },
...
export const deviceClassify = (data) =>
  axios.request({
    url: "bt/temperature/index/list/deviceClassify",
    method: "get",
    params: {
      ...data,
    },
...
export const deviceStatus = (data) =>
  axios.request({
    url: "bt/temperature/index/list/status",
    method: "get",
    params: {
      ...data,
    },
...
export const alarmDate = (data) =>
  axios.request({
    url: "bt/temperature/index/list/date",
    method: "get",
    params: {
      ...data,
    },
